public abstract class Customer {
	    ...
	    // no-argument constructor for abstract class Customer
        /*
         no-argument constructor initializes instance variables with default values they will be later  
         set to their actual values by using setters
         */
	    public Customer()  {
