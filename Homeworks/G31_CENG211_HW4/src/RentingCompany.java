...
public class RentingCompany implements IRentable {
	...
	public void simulateRentingCompany() {
		     ...
		     // at the end of the for loop we will get the total commercial and individual rentals
		     
		     
		     // calculating total number of commerical rentals-month and total individual rentals-day
		     ...
		     for (Customer customer: customerList) {
		    	 ...
		    	 /* at the end of the for loop we will have found the
		    	    totalCommercialRentalsMonth and totalIndividualRentalsDay
		    	 */
		     ...
		     System.out.println("Total number of rentals of platinum commercial customers: " + totalPlatinumCommercialRentals);
		     ...
		     for (Customer customer: customerList) {
		    	  ...
		    	  if (customer instanceof IndividualCustomer) {
						...
						IndividualCustomer individualCustomer = (IndividualCustomer) customer;
		    			/*
		    			   we are sure that given customer is individual customer and 
		    			   so we can make type cast safely  
		    			 */
			     ...
			     System.out.println();
			     System.out.println("No\t"+"Rental Code\t"+"Customer ID\t"+"Customer Type\t\t"+"IsMember\t"+"Number of Months\t"+"Car Model\t\t"+"Model Year\t"+"Rental Price");
	...
	public ArrayList<Customer> calculatePriceOfRentals()  {
		     ...
		     /* adding customer after calculating rentalPrice 
		        for each of them to updatedList
		     */
	...
	public void printOtherCommercialCustomers(ArrayList<Customer> list) {
		...
		// then we need to calculate rental amount for each of these commercial customers
	    if (newCommercialCustomers.size() != 0) {	
	    	...
	    	for (int i = 0; i < newCommercialCustomers.size(); i++) {
				...
				if (!linearSearch(checkerList,newCommercialCustomers.get(i))) {
					...
					System.out.println("Total number of rentals of " + newCommercialCustomers.get(i).getCustomerType() + " commercial customers: " + total);
